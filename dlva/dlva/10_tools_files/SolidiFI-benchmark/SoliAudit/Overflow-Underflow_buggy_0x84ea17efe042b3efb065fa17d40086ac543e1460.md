...
* _`X`_ Underflow
    - 49%, SLOAD SUB
        ...
        - Line 36, 13 ``balances_intou10[msg.sender]``
        - Line 37, 5 ``balances_intou10[msg.sender] -= _value``
    ...
    - 20%, SUB LT
        ...
        - Line 36, 13 ``balances_intou10[msg.sender] - _value``

* _`X`_ Overflow
    - 100%, SWAP POP POP JUMP PUSHDEPLOYADDRESS

        - Line 13, 5 ``function sub(uint256 a, uint256 b) internal pure returns(uint256) {
        assert(b <= a);
        return a - b;
    }``
